...
contextBridge.exposeInMainWorld('api', {
  ...
  askView: {
    ...
    // 方案4：上下文管理
    clearScreenshotContext: () => ipcRenderer.invoke('ask:clearScreenshotContext'),
    getScreenshotContext: () => ipcRenderer.invoke('ask:getScreenshotContext'),
    ...
    // 方案4：上下文更新监听器
    onContextUpdate: (callback) => ipcRenderer.on('ask:contextUpdate', callback),
    removeOnContextUpdate: (callback) => ipcRenderer.removeListener('ask:contextUpdate', callback),
